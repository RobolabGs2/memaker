...
<Modal open={fallbackBlob != null} on:close={() => (fallbackBlob = null)}>
	...
	<main>
		...
		<p>
			...
			>, открыв в новой вкладке страницу <span>about:config</span>. Тогда, после перезагрузки
			страницы, вы перестанете видеть это окно, а функционал копирования заработает корректно.
		</p>
