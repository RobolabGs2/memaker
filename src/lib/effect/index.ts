...
import type {
	...
	ShaderSettings,
	ShaderUniforms
} from '$lib/graphics/shader';
import { PixelationShader } from './pixelation';

export type EffectSettings = ShaderUniforms;
export type Effect = ShaderSettings;
...
const defaultShaders: ShaderResource[] = [
	...
	{
		name: 'grayscale',
		shader: { title: 'Оттенки серого', fragment: grayscaleShader },
		source: 'default'
	},
