...
- Теперь можно задавать относительный размер шрифта в долях высоты или ширины кадра.
- Теперь можно редактировать коэффициент отступа текста.

### Изменено

- Междустрочный интервал и настройки размера шрифта были перенесён под поле ввода текста.
