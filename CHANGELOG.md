...
- Во всех пресетах выставлена стратегия размера. Раньше она была выставлена только у импакта и субтитров, что приводило к контринтуитивному поведению. Теперь у всех, кроме субтитров, стоит "одинаковая высота".
...
- Новый режим подбора размера шрифта: по всей ширине. Для каждой строчки размер шрифта подбирается отдельно так, чтобы все строчки оказались одной ширины.
  В этом режиме междустрочный интервал измеряется в пикселях, а не в строках.
